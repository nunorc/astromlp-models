...
mlflow.set_tag('model', 'iFsSSbW2r')
...
train_gen = DataGen(ids_train, x=['img','fits','spectra','ssel','bands','wise'], y=['redshift'], batch_size=batch_size, helper=helper)
val_gen = DataGen(ids_val, x=['img','fits','spectra','ssel','bands','wise'], y=['redshift'], batch_size=batch_size, helper=helper)
test_gen = DataGen(ids_test, x=['img','fits','spectra','ssel','bands','wise'], y=['redshift'], batch_size=batch_size, helper=helper)
...
model = iFsSSbW2r.model(snorm, ssnorm, bnorm, wnorm)
loss_funs = {
