...
train_gen = DataGen(ids_train, x=['bands'], y=['smass'], batch_size=batch_size, helper=helper)
val_gen = DataGen(ids_val, x=['bands'], y=['smass'], batch_size=batch_size, helper=helper)
test_gen = DataGen(ids_test, x=['bands'], y=['smass'], batch_size=batch_size, helper=helper)
