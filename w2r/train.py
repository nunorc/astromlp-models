...
train_gen = DataGen(ids_train, x=['wise'], y=['redshift'], batch_size=batch_size, helper=helper)
val_gen = DataGen(ids_val, x=['wise'], y=['redshift'], batch_size=batch_size, helper=helper)
test_gen = DataGen(ids_test, x=['wise'], y=['redshift'], batch_size=batch_size, helper=helper)
