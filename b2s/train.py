...
train_gen = DataGen(ids_train, x=['bands'], y=['subclass'], batch_size=batch_size, helper=helper)
val_gen = DataGen(ids_val, x=['bands'], y=['subclass'], batch_size=batch_size, helper=helper)
test_gen = DataGen(ids_test, x=['bands'], y=['subclass'], batch_size=batch_size, helper=helper)
